...
namespace APIVerve.API.CPIInflation
{
    ...
    /// <summary>
    /// Client for the CPIInflation API
    /// </summary>
    public class CPIInflationAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/cpiinflation";
        ...
        public CPIInflationAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CPIInflationAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CPIInflationAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CPIInflationQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CPIInflationQueryOptions options)
        {
        ...
        public ResponseObj Execute(CPIInflationQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CPIInflationQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CPIInflationQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CPIInflationQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CPIInflationQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CPIInflationQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CPIInflationQueryOptions options)
        {
