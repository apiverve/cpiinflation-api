...
{
    class CPIInflationExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/cpiinflation";

        /// <summary>
        /// Make a GET request to the CPI Inflation API
        /// </summary>
        static async Task<JsonDocument> CallCPIInflationAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;date&quot;] &#x3D; &quot;2023-06&quot;, [&quot;category&quot;] &#x3D; &quot;food&quot; };
        ...
        {
            Console.WriteLine("📤 Calling CPI Inflation API...\n");

            var result = await CallCPIInflationAPI();
