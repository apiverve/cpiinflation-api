...
```gradle
dependencies {
    implementation 'com.github.apiverve:cpiinflation-api:1.1.14'
}
```
...
```java
import com.apiverve.cpiinflation.CPIInflationAPIClient;
import com.apiverve.cpiinflation.APIResponse;
import com.apiverve.cpiinflation.APIException;

// Initialize the client
CPIInflationAPIClient client = new CPIInflationAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("date", "2024-01");
    parameters.put("category", "food");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/cpiinflation](https://docs.apiverve.com/ref/cpiinflation)
...
- **Documentation:** [https://docs.apiverve.com/ref/cpiinflation](https://docs.apiverve.com/ref/cpiinflation)
- **Issues:** [GitHub Issues](https://github.com/apiverve/cpiinflation-api/issues)
