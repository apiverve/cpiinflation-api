...
namespace APIVerve\Cpiinflation;
...
/**
 * Client for the CPI Inflation API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/cpiinflation?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/cpiinflation';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CpiinflationClient] {$message}\n";
        }
    }
}
